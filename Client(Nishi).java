...
public class Client extends JFrame implements MouseListener {
	...
	public Client() {
		...
		JLabel columnNumber = new JLabel("1　　2　　3　　4　　5　　6　　7　　8");//列番号の表示
		columnNumber.setBounds(35, 0, TABLE_W, FIELD_H);
		columnNumber.setFont(new Font("MSゴシック",Font.PLAIN,18));
		JLabel rowNumber = new JLabel("<html>1<br/><br/>2<br/><br/>3<br/><br/>4<br/><br/>5<br/><br/>6<br/><br/>7<br/><br/>8</html>");//行番号の表示
